...
public sealed class BridgeScenarioTests
{
    ...
    public void AbiContractRemainsStable()
    {
        ...
        Assert.Equal("2|2|2|1.4.5.6", (string)handshake.Invoke(null, null));
    ...
    public void HandshakeParsingReportsCompatibilityFailures()
    {
        ...
        Assert.True(BridgeCompatibilityDescriptor.TryParse("2|2|2|1.4.5.6", out BridgeCompatibilityDescriptor current, out string diagnostic));

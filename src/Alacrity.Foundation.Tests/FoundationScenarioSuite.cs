...
public static class FoundationScenarioSuite
{
    ...
    private sealed class TestTerrariaServices : ITerrariaServices
    {
        ...
        public IPluginPresentationSuppressionService Presentation { get; } = new TestPresentationSuppression();
    }
    ...
    private sealed class TestPresentationSuppression : IPluginPresentationSuppressionService
    {
        public IPluginRegistration RegisterPolicy(PluginPresentationSuppressionPolicy policy) => new TestRegistration("presentation-suppression");
    }
